...
function webSocketInit(model, realLength, methods, types) {
	...
	ME.test = new WebSocket("ws://114.116.13.42:32501");

	//ME.test.binaryType = 'arraybuffer';	
	
    ME.test.onopen = function (event) {
        

    }
    ME.test.onclose = function (event) {

    }
    ME.test.onmessage = function (event) {
